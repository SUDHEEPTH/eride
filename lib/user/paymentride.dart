...
class paymentride extends StatefulWidget {
  final String price;
  final String revid;
  final String useid;
  final String tcid1;
  paymentride({required this.price, required this.revid,required this.useid,required this.tcid1});

  @override
  State<paymentride> createState() => _paymentrideState();
}
...
class _paymentrideState extends State<paymentride> {
  String username = "";
  String login_id = "";
  ...
  void pay() async {
    ...
    var res = await Api().authData(data, '/payment/payment6');
