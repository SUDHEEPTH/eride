...
class _ProfileUserState extends State<ProfileUser>
  ...
  Future<void> _viewPro() async {
    ...
    var res = await Api().getData('/register/viewselect-user/$mid');
  ...
  _update() async {
    ...
    print(data);
    var res = await Api().authData(data, '/taxih/updateuser/' + _id);
    var body = json.decode(res.body);
  ...
  _updatepass() async {
    ...
    print(data);
    var res = await Api().authData(data, '/taxih/updateuserpass/' + login_id);
    var body = json.decode(res.body);
