...
class Payment5 extends StatefulWidget {
  final String price;
  final String revid;
  final String useid;
  final String tcid1;
  Payment5({required this.price, required this.revid,required this.useid,required this.tcid1});

  @override
  State<Payment5> createState() => _Payment5State();
}
...
class _Payment5State extends State<Payment5> {
  String username = "";
  String login_id = "";
  ...
  void initState() {
    ...
    super.initState();
    amount = widget.price;
    resive_id = widget.revid;
    user_id= widget.useid;
    what= widget.tcid1;
    print("object amount$amount");
    print("object re$resive_id");
    print("object re$user_id");
  ...
  void pay() async {
    ...
    var res = await Api().authData(data, '/payment/payment');
