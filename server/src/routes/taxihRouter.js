...
taxihRouter.post('/updateuser/:id', async function (req, res) { 
    try {
        const productId = req.params.id; 
        const details = {
          email: req.body.email,
        ...
        const product = await userModel.updateOne({_id:productId},{$set:details})
  ...
  taxihRouter.post('/updateuserpass/:id', async function (req, res) { 
    try {
        const productId = req.params.id; 
        const details = {
          password: req.body.password,
